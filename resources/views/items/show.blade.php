                                    ...
                                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                        <div class="w-0 flex-1 flex items-center">
                                            ...
                                            <img src="{{ $recipe->item->icon }}" class="flex-shrink-0 h-5 w-5"
                                                aria-hidden="true" />
                                            <span class="ml-2 flex-1 w-0 truncate"> {{ $recipe->item->name }} - {{ $recipe->crafting_cost }} </span>
                                        </div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                @foreach ($item->listing->sell as $listing)
                                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                        <div class="w-0 flex-1 flex items-center">
                                            <span class="ml-2 flex-1 w-0 truncate"> <x-price price="{{ $listing['unit_price'] ?? null }}"></x-price> -
